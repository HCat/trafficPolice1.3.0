...
- (UIButton *)button
{
    if (!_button)
    {
        ...
        _button.layer.borderColor = [UIColor colorWithRed:49/255.f green:139/255.f blue:255/255.f alpha:1.f].CGColor;
...
- (void)setupConstraints
{
    ...
    if (_customView) {
        ...
        if ([self canShowButton]) {
            ...
            [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(padding@750)-[button(80)]-(padding@750)-|"
                                                                                     options:0 metrics:metrics views:views]];
