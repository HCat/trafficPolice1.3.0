...
+ (UIImage *)addWatemarkTextAfteriOS7_WithLogoImage:(UIImage *)logoImage watemarkText:(NSString *)watemarkText needHigh:(BOOL)isHigh{
    ...
    if (isHigh) {
        ...
        [watemarkText drawInRect:CGRectMake(w/12, h/2 - h/10 , w*5/6, h/10) withAttributes:@{NSFontAttributeName:font,NSForegroundColorAttributeName:[UIColor whiteColor],NSBackgroundColorAttributeName:[UIColor colorWithWhite:0.f alpha:0.2]}];
                          ...
                          attributeColor:(UIColor *)attributeColor
{
    ...
    if ([sender isKindOfClass:[NSArray class]]) {
        ...
        [sender enumerateObjectsUsingBlock:^(NSString *  _Nonnull str, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            oringinStr = [oringinStr stringByReplacingCharactersInRange:range withString:[ShareFun getStringWithRange:range]];
        }];
