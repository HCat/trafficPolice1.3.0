...
#define NOTIFICATION_THROUGHMANAGE_SUCCESS @"NOTIFICATION_THROUGHMANAGE_SUCCESS"                //闯禁令管理采集提交成功
#define NOTIFICATION_VIDEO_SUCCESS @"NOTIFICATION_VIDEO_SUCCESS"                                //视频采集提交成功
#define NOTIFICATION_ILLEGALEXPOSURE_SUCCESS @"NOTIFICATION_ILLEGALEXPOSURE_SUCCESS"            //违法曝光提交成功
...
#define NOTIFICATION_PARKINGFORENSICS_SUCCESS @"NOTIFICATION_PARKINGFORENSICS_SUCCESS"          //停车取证成功之后通知

#define NOTIFICATION_MAINCOMMON_SUCCESS @"NOTIFICATION_MAINCOMMON_SUCCESS"                      //首页常用应用保存

#define NOTIFICATION_ILLEGALADDSS_SUCCESS @"NOTIFICATION_ILLEGALADDSS_SUCCESS"  //石狮采集成功之后操作
#define NOTIFICATION_STREETADDSS_SUCCESS @"NOTIFICATION_STREETADDSS_SUCCESS"  //街道采集成功之后操作
