...
//    [paragraphStyle setLineSpacing:2.0f]; //设置行间距
//    [paragraphStyle setLineBreakMode:NSLineBreakByTruncatingTail];
//    [paragraphStyle setAlignment:NSTextAlignmentCenter];
//    [paragraphStyle setLineBreakMode:NSLineBreakByCharWrapping];
//    [attrbuteString addAttribute:NSParagraphStyleAttributeName value:paragraphStyle range:NSMakeRange(0, [string length])];
    [attrbuteString setText:centerString color:C_HEX(0x666666) font:[UIFont fontWithName:@"PingFangSC-Regular" size:GG_SIZE_CONVERT(12)]];
    [attrbuteString setText:smallString color:C_HEX(0x666666) font:[UIFont fontWithName:@"PingFangSC-Regular" size:GG_SIZE_CONVERT(14)]];
