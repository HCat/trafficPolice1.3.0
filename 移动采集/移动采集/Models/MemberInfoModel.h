...
@property (nonatomic,copy)   NSString * contactphone;       //法人电话
@property (nonatomic,copy)   NSString * manager;            //车队管理员
@property (nonatomic,copy)   NSString * managePhone;        //车队管理员电话
@property (nonatomic,copy)   NSString * safer;              //安全管理员
@property (nonatomic,copy)   NSString * safePhone;          //安全管理员电话
