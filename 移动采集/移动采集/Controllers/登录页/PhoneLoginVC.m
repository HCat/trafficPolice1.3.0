...
- (void)viewDidLoad {
    ...
    self.layout_top.constant = 10 + Height_StatusBar;
    ...
    [manger startWithCompletionBlockWithSuccess:^(__kindof YTKBaseRequest * _Nonnull request) {
        if (manger.responseModel.code == CODE_SUCCESS) {
            ...
            dispatch_after(time, dispatch_get_main_queue(), ^{
                ...
                ApplicationDelegate.mainvc = [[MainVC alloc] init];
                ApplicationDelegate.nav_main = [[UINavigationController alloc] initWithRootViewController:ApplicationDelegate.mainvc];
                ApplicationDelegate.window.rootViewController = ApplicationDelegate.nav_main;
