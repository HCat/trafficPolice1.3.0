...
@interface ThroughManageViewModel : BaseViewModel
...
@property(nonatomic, strong) RACCommand * command_carCount;         //车牌查询违章次数
@property(nonatomic, strong) RACCommand * command_identNoCount;    //身份证位置次数查询
