...
- (void)viewDidLoad {
    ...
    self.layout_top_height.constant = Height_NavBar;
...
- (void)searchVehicle:(NSString *)plateNO{
    ...
    WS(weakSelf);
    [VehicleCarMoreVC loadVehicleRequest:VehicleRequestTypeCarNumber withNumber:plateNO withBlock:^(VehicleDetailReponse *vehicleDetailReponse) {
        SW(strongSelf, weakSelf);
        VehicleCarMoreVC * t_vc = [[VehicleCarMoreVC alloc] init];
        t_vc.type = VehicleRequestTypeCarNumber;
        t_vc.numberId = plateNO;
