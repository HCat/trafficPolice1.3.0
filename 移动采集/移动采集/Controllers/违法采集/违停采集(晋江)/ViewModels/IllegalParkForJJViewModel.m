...
#import "IllegalParkForJJViewModel.h"
#import "CommonAPI.h"
#import "UserModel.h"


@implementation IllegalParkForJJViewModel
...
- (void)handleBeforeCommit{
    ...
    [[LocationStorage sharedDefault] setPark:model];
