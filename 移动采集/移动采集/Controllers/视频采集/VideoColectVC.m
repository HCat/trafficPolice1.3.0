...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *layout_playView_top;
...
//    }];
    ...
    self.layout_view_top.constant = 145 + Height_NavBar;
    self.layout_playView_top.constant = 11 + Height_NavBar;
...
- (IBAction)handleBtnCommitClicked:(id)sender {
    ...
    if ([UserModel isPermissionForVideoCollect] == NO) {
