...
@implementation IllegalAddListViewModel
    ...
    if (_command_loadList == nil) {
        ...
        _command_loadList = [[RACCommand alloc] initWithSignalBlock:^RACSignal * _Nonnull(id  _Nullable input) {
            ...
            RACSignal * t_signal = [RACSignal createSignal:^RACDisposable * _Nullable(id<RACSubscriber>  _Nonnull subscriber) {
                ...
                IllegalListPagingParam *param = [[IllegalListPagingParam alloc] init];
                ...
                IllegalListPagingManger * manger = [[IllegalListPagingManger alloc] init];
                manger.param = param;
