...
@property (nonatomic,strong) TaskFlowsAddViewModel * viewModel;

@end

@implementation TaskFlowsAddVC

- (instancetype)init{
    
    if (self = [super init]) {
        self.viewModel = [[TaskFlowsAddViewModel alloc] init];
    }
...
- (void)dealloc{
    LxPrintf(@"TaskFlowsAddVC dealloc");
}
